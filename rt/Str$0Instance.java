...
public record Str$0Instance(String val) implements Str$0{
  ...
  static final long maxNatU= Nat$0Instance.MAX_UNSIGNED_VALUE;
  ...
  @Override public Object imm$natExact$0(){
    ...
    try{
      // throws if the number is negative or too large.
      long x= Long.parseUnsignedLong(no_(val));
      return optSome(Nat$0Instance.instance(x)); // bit-cast semantics via int bits
    }
