...
public final class EList$1Instance implements EList$1 {
    public static EList$1Instance wrap(List<Object> l) {
        return new EList$1Instance(new ArrayList<>(l));
    }
    public static EList$1Instance empty() {
    ...
    @Override
    public Object mut$addAnd$1(Object p0) {
        xs.add(p0);
        return this;
    }
    ...
    public Object read$size$0() {
        return Nat$0Instance.instance(xs.size());
    }

    @Override
    public Object mut$seqFlow$0() {
        return new Flow$1Instance(drain().stream());
    }
    ...
    @Override
    public Object mut$sortAnd$1(Object p0) {
        mut$sort$1(p0);
        return this;
    }
    ...
    @Override
    public Object mut$distinctAnd$1(Object p0) {
        distinctByHash(p0);
        return this;
    }
    ...
    @Override
    public Object mut$sortDistinctAnd$1(Object p0) {
        sortDistinctInPlace(p0);
        return this;
    }
}
