...
final class ESet$1Instance implements ESet$1 {
    ...
    static Object wrap(LinkedHashSet<MapKey> s, OrderHashBy$2 ordering){ return new ESet$1Instance(new LinkedHashSet<>(s), ordering); }
    ...
    @Override public Object mut$addAll$1(Object p0) {
        ESet$1Instance other = (ESet$1Instance) p0;
