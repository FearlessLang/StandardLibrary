...
public interface CacheF$2p$2 extends base.CacheHandler$4sg$0{
  ...
  default Object imm$_get$1(Object p0){
    ...
    return CacheF$2p$2.myCache.computeIfAbsent(this,v->new Cache1(1,v)).get(a$);
  }
  java.util.concurrent.ConcurrentHashMap<CacheF$2p$2, Cache1> myCache= new java.util.concurrent.ConcurrentHashMap<>();
}