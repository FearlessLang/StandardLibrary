...
record SerialQueue(BlockingQueue<MF$7$1> q, Thread t){
  public SerialQueue(Consumer<Throwable> onError){ this(new LinkedBlockingQueue<>(), onError); }
  private SerialQueue(BlockingQueue<MF$7$1> q, Consumer<Throwable> onError){ this(q, makeThread(q, onError)); }
  private static Thread makeThread(BlockingQueue<MF$7$1> q, Consumer<Throwable> onError) {
