...
public interface Sets$0 extends Sealed$0 {
  ...
  default Object imm$$hash$1(Object p0){
    var ordering = Set$1Instance.ordering(p0);
    return new Set$1Instance(ordering, emptyList);
  }
  default Object imm$$hash$2(Object p0, Object p1){
    var ordering = Set$1Instance.ordering(p0);
    return Set$1Instance.fromSortedList(ordering, List.of(p1));
  }
  default Object imm$$hash$3(Object p0, Object p1, Object p2){
    var ordering = Set$1Instance.ordering(p0);
    var s = new ArrayList<>(2);
    s.add(p1); s.add(p2);
    return Set$1Instance.fromUnsortedList(ordering, s);
  }
